...
import "../guest/ReportIncidentPage.css";
...
function UserReportIncidentPage() {
  ...
  return (
    <div className="report-page">
      ...
      <main className="report-main">
        <UserTopbar title="Korisnički panel - Prijava incidenta" />
...
export default UserReportIncidentPage;